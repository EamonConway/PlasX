from pyPlasX.pvibm import Population, HumanParameters, equilibrium_run, CreateInitialPopulation
import matplotlib.pyplot as plt

parameters = HumanParameters(num_people=1000,
                             delay=10.0,
...
population = CreateInitialPopulation(parameters)
t, y = equilibrium_run(
    0.0, 1000.0*365.0, 1.0, 40.0*parameters.num_people, population, parameters)
